<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="model.Scientist, model.LabReagent, java.util.ArrayList" %>
...
<%
ArrayList<LabReagent> lrl = (ArrayList<LabReagent>)session.getAttribute("labReagentList");
    ...
    <div class="col-xs-12 col-sm-6">
      <table width="100%" id="labInfo">
                  ...
                  <tr><td width="35%" align="right" valign="middle"><span>Institute:</span></td>
                      <td width="65%" align="left" valign="middle"><span><%=lrl.get(i).getInstitute() %></span></td></tr>
                  <tr><td width="35%" align="right" valign="middle"><span>Address:</span></td>
                      <td width="65%" align="left" valign="middle"><span><%=lrl.get(i).getAddress() %></span></td></tr>
                  <tr><td width="35%" align="right" valign="middle"><span>Research Area:</span></td>
                      <td width="65%" align="left" valign="middle"><span><%=lrl.get(i).getRsarea() %></span></td></tr>
